 ...
 */
final class Version20231116103505 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE annonces CHANGE categories_id categories_id INT DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE annonces CHANGE categories_id categories_id INT NOT NULL');
    }
}
